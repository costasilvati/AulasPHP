...
É possível criar muitas cores utilizando RGB (red, green, blue)\\
	\begin{center}
		  \includegraphics[height=0.4\paperheight]{fig/aula3/rgb.png} \\
		  \tiny Cores rgb.
	  \end{center}
	  \begin{center}
...
É possível criar muitas cores utilizando Hexadecimal \#rrggbb\\
	\begin{center}
		\includegraphics[height=0.4\paperheight]{fig/aula3/hex.png} \\
...
alpha)\\
	\begin{center}
		  \includegraphics[height=0.4\paperheight]{fig/aula3/rgba.png} \\
		  \tiny Cores Hexadecimal.
	  \end{center}
	  \begin{center}
...
Crie uma página colors\_page.html com essa estrutura:
	\begin{center}
	 \lstinputlisting[linerange={21-28}]{fig/aula3/colors_page.html}
	\end{center}	  
\end{frame}
%---------------------------------------------------------------------------
\begin{frame}{O poder das Cores CSS}
Acrescente este estilo:
	\begin{center}
	 \lstinputlisting[linerange={5-15}]{fig/aula3/colors_page.html}
	\end{center}	  
\end{frame}
%-------------------------------------------------------------------------------
\section{Formulário}
